...
impl Comparaison {
    ...
    pub fn compare(&mut self, current: &FileFacade, previous: &FileFacade) -> &Self {
        ...
        let result = Diff::new(self.path.clone(), previous.file(), current.file()).set_result(diff_result);
    ...
    pub fn compare_similarity(&self, current: &FileFacade, previous: &FileFacade) -> Value {
